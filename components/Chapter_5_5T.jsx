...
const Chapter_5_5T = () => {
  return (
    <section className={`${styles.paddings} relative z-10 gap-8`}>
      ...
      >
        <TitleText title={<>Travelling Salesman Problem (TSP)</>} textStyles="text-center" />
