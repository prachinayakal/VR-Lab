  ...
  return (
    <section className={`${styles.paddings} relative z-10 gap-8`}>
      ...
      >
        ...
        >
          Given I to P, a Las-Vegas algorithm uses some (r) random
numbers, but except for choosing random numbers it proceeds
completely deterministically. <br /> <br />
LV’s solution is always correct as in deterministic alg. <br /> <br />
We say that LV solves P in expected time T(n) if for every I such
that |I| = n, LV solves I in expected time ≤ T(n). <br /> <br />
By expected time we mean the average of all solution times of I by
LV for all possible choice sequences of r random numbers (which
we assume to be equally likely). Note the difference in assumption
from average-case analysis. <br /> <br />
        </motion.p>
        <motion.img
